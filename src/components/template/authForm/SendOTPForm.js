...
function SendOTPFrom({ mobile, setMobile, setStep, isOpen, setIsOpen,responsive  }) {
  ...
  return (
      ...
      <ModalContainer isOpen={isOpen} setIsOpen={setIsOpen}>
        <div className={`${responsive ? "w-[358px] h-[362px]" : ""} flex flex-col p-10 m-auto rounded-[20px] shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] bg-[#ffffff]`}>
